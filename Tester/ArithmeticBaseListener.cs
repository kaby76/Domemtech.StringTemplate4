...
public partial class ArithmeticBaseListener : IArithmeticListener {
	...
	public virtual void EnterFile_([NotNull] ArithmeticParser.File_Context context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ArithmeticParser.file_"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitFile_([NotNull] ArithmeticParser.File_Context context) { }
	/// <summary>
